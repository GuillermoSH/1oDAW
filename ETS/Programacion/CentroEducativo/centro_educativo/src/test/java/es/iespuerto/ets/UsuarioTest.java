...
public class UsuarioTest {
    ...
    public void exceptionUsuarioTest() {
        Exception thrownEmail = Assertions.assertThrows(Exception.class, () -> marcos = new Usuario("emailIncorrecto@yahoo","MarquitoS_93#"));
        Assertions.assertTrue(thrownEmail.getMessage().contains("Su email debe ser '@gmail.com', '@hotmail.com' o '@gobiernodecanarias.org'."));

        //Exception thrownContraConDigitos = Assertions.assertThrows(Exception.class, () -> marcos = new Usuario("@gmail.com","estanofuncionacondigitos1221"));
    ...
    public void exceptionValidarEmailTest() {
        String newEmailMarcos = "emailIncorrecto@yahoo";
