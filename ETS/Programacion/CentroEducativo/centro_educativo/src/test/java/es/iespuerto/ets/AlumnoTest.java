...
public class AlumnoTest {
    ...
    public void beforeEach() {
        ...
        // Creacion del alumno
        alumno1 = new Alumno("JuaN anToNIO", "HerNANDEz PeREZ", 43383780, "24-04-2004", matriculas);
        alumno2 = new Alumno("MaRIA", "GarCIA ROdriGuEZ", 43651235, "04-12-2000", matriculas);
    }
    ...
    public void getApellidosTest() {
        ...
        alumno2 = new Alumno("MaRIA", "GarCIA", 43651235, "04-12-2000", matriculas); 
    ...
    @Test
    public void exceptionGetFechaNacimientoTest() {
        alumno1 = new Alumno("JuaN anToNIO", "HerNANDEz PeREZ", 43383780, "31-04-2004", matriculas);
        alumno2 = new Alumno("MaRIA", "GarCIA ROdriGuEZ", 43651235, "30-12-10000", matriculas);

        Exception thrown1 = Assertions.assertThrows(Exception.class, () -> alumno1.getFechaNacimiento(false));

        Assertions.assertTrue(
                thrown1.getMessage().contains("Error Fecha.getDia(): el dia es incorrecto."));

        Exception thrown2 = Assertions.assertThrows(Exception.class, () -> alumno2.getFechaNacimiento(true));

        Assertions.assertTrue(
                thrown2.getMessage().contains("Error Fecha.getAnio(): el anio es incorrecto."));
    }
    ...
    public void exceptionEditarMatriculaTest() {
        Exception thrown = Assertions.assertThrows(Exception.class, () -> alumno1.editarMatricula(matricula2022,matricula2021));
