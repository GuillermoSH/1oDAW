...
public class MatriculaTest {
    ...
    @Test
    public void getNumeroDniTest() {
        Assertions.assertEquals(43383780, alumno1.getNumeroDni());
    }
    ...
    public void isPagadaTest() {
        ...
        Assertions.assertTrue(alumno1.isPagada(precioTotal));
    }
    ...
    public void exceptionAgregarAsignaturaTest() {
        ...
        alumno1.isPagada(asignatura1.getPrecio());
    ...
    public void imprimeMatriculaTest() throws Exception {
        Assertions.assertEquals("Matricula del alumno con dni: " + alumno1.getDni() + ", en el centro "
                + alumno1.getNombre() + ", a " + alumno1.getFecha(true), alumno1.imprimeMatricula(true));
    }
}
